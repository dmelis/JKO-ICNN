"""
This model class is taken from https://github.com/molecularsets/moses and released under the MIT license found there.
"""
import random
...
def set_seed(seed):
    """
    This method is taken from https://github.com/molecularsets/moses/blob/master/moses/script_utils.py
